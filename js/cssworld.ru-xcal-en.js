...
(function () {
  ...
  function scrol(y) {
    ...
    return (
      ...
      document.documentElement[a[y]] ||
      document.body[a[y]]
    );
  }

  window.xCal = function (ob, delim, order) {
    // xCal(this,'-',1) // xCal() == close
    var a = {};
    ...
    a.f = function () {
      ...
      else if (typeof a.fn === "string" && a.fn !== "")
        eval(a.fn + "('" + d + "');");
    };
    ...
    xCal.fM = function (a) {
      ...
      HTM(
        a.id,
        '<tbody><tr><th rowspan=4 valign=bottom><a href="http://cssworld.ru/en/datepicker/" target="_blank">?</a></th>' +
          ca +
          "</tr></tbody>"
      );
    ...
    xCal.fY = function (a) {
      ...
      HTM(
        a.id,
        '<tbody><tr><th rowspan=5 valign=bottom><a href="http://cssworld.ru/en/datepicker/" target="_blank">?</a></th>' +
          ca +
          "</tr></tbody>"
      );
      var k = document.querySelectorAll("#" + a.id + " tbody td");
    ...
    xCal.f = function (a) {
      ...
      HTM(
        a.id,
        '<thead><tr><td class="cal-l" title="' +
          lang[a.lang].pre +
          '">‹</td><td colspan=3 class="cal-m"></td><td colspan=2 class="cal-y"></td><td class="cal-r" title="' +
          lang[a.lang].nex +
          '">›</td></tr><tr><td>' +
          lang[a.lang].w +
          "</td></tr></thead>"
      ...
      for (var i = 1; i <= Dlast; i++) {
        ...
        } else if (i == a.tdat && m == a.tmonth && y == a.tyear)
          ca += ' class="tday"';
        ca += ">" + i + "</td>";
        if (j > 6) {
          ca += "</tr><tr>";
      ...
      if (a.x) {
        ...
        ca +=
          ...
          lang[a.lang].x +
          '" class="bold">' +
          (kk[2] > 2 ? lang[a.lang].x : "&#215;") +
          "</td>";
      }
      HTM(a.id, "<tfoot><tr>" + ca + "</tr></tfoot>");

      document.querySelector("#" + a.id + " thead td.cal-m").innerHTML =
        months[m];
      document.querySelector("#" + a.id + " thead td.cal-y").innerHTML = y;
      document.querySelector("#" + a.id + " thead td.cal-l").onclick =
        function () {
          xCal.mmm(a);
        };
      document.querySelector("#" + a.id + " thead td.cal-r").onclick =
        function () {
          xCal.mpp(a);
        };
      document.querySelector("#" + a.id + " thead td.cal-m").onclick =
        function () {
          xCal.fM(a);
        };
      document.querySelector("#" + a.id + " thead td.cal-y").onclick =
        function () {
          xCal.fY(a);
        };
  ...
  xCal.all = function (cl, delim, order) {
    ...
    if (document.getElementsByClassName)
      oo = document.getElementsByClassName(cl);
    ...
    for (var i = 0; i < oo.length; i++) {
      ...
      if (typeof delim === "object") {
        if ("autoOn" in delim && delim.autoOn)
          Eve(o, "mouseenter", function () {
            xCal(this, delim, order);
          });
      } else if (def.autoOn)
        Eve(o, "mouseenter", function () {
